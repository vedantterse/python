...
print('''\033[34mENTER:\033[0m
        ...
        \033[36m 1 for pdf merger\033[0m \033[33m[PDF_merger]\033[0m
         \033[36m2 for image to PDF\033[0m \033[33m[clutterpng]\033[0m
...
def create_directories():
    required_directories = ['PDF_merger', 'merger_pdf', 'clutterpng', 'img2pdf_output', 'PDF_ENCRYPT',
...
while True:
    ...
    if w == "1":
        ...
        if __name__ == "__main__":
            ...
            output_directory = "merger_pdf"  # Output directory path
        ...
        if __name__ == "__main__":
            input_directory = "Clutterpng"  # Compulsory input directory path (Change if necessary)
        ...
        if __name__ == "__main__":
            while True:
                ...
                try:
                    ...
                    if start_page.lower() == "exit":
                        break
                    end_page = int(input("Enter the ending page number: "))
                    if end_page.lower() == "exit":
                        break
